...
import body_banner from '../../../images/body-banner.jpg';

const NewLetter = () => {
  return (
    <div className="flex justify-center">
      <section class="container my-4 text-gray-600 body-font bg-red-100 rounded-xl">
        <div class="container mx-auto flex px-5 lg:px-12 py-12 md:flex-row flex-col items-center">
          <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">
              Join our NewsLetter
            </h1>
            <p class="mb-8 leading-relaxed">
              Join now to get latest news , updates , latest services and many more.
            </p>
            ...
            <div class="flex lg:flex-row md:flex-col">
              <button class="bg-gray-100 inline-flex py-3 px-5 rounded-lg items-center hover:bg-red-200 focus:outline-none">
                <svg
              ...
              <button class="bg-gray-100 inline-flex py-3 px-5 rounded-lg items-center lg:ml-4 md:ml-0 ml-4 md:mt-4 mt-0 lg:mt-0 hover:bg-red-200 focus:outline-none">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  class="w-6 h-6"
